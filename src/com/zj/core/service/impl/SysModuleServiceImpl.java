...
public class SysModuleServiceImpl extends CommonServiceImpl implements ISysModuleService{
	private static final Log log = LogFactory.getLog(SysModuleServiceImpl.class);
	@Override
	...
	public List<ZTreeNode> loadModulesByRoles(Collection<SysRole> roles,Long parentId) throws ServiceException {
		...
		if(isSuperAdmin){
			...
			String hql = "from SysModule module where module.parentId="+parentId;
			List<SysModule> allMoudles = dao.queryHQL(hql);
