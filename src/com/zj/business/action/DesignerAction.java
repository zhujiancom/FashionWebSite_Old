...
public class DesignerAction extends BaseAction {
	...
	private static final Log log = LogFactory.getLog(DesignerAction.class);
	...
	public String loadAll(){
		try {
			...
			Collections.sort(designers, new Comparator<Designer>(){

				@Override
				public int compare(Designer d1, Designer d2) {
					return d1.getEname().compareTo(d2.getEname());
				}
