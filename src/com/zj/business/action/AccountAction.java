...
//		HttpServletRequest request = ServletActionContext.getRequest();
		...
		try{
			...
			if(login_account == null){
				getValueStack().set("loginMsg","This account has not registered. Please register first");
	...
	public String resetPassword(){
		try {
			Account act = accountService.getAccount(account.getAccountname());
			act.setPswd(account.getPswd());
			accountService.update(act);
		} catch (ServiceException e) {
