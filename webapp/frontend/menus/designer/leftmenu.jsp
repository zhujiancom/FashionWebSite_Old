        ...
        <div id="menus">
            <div id="nav">
                <ul id="menu" class="nav">
                    <li class="active"><a href="javascript:void();" title="<s:text name='signintip.menushow'/>">Home</a></li>
							...
							<s:if test="!#menu.items.isEmpty() || !#menu.subMenus.isEmpty()">
								<ul>
									...
									<s:iterator value="#menu.subMenus" var="subMenu">
										<li>
											<a href="javascript:void(0);"><s:property value="#subMenu.name"/></a>
											<ul>
                ...
                <p style="font-size:12px;"><s:text name='signintip.menushow'/></p>
            </div>
        </div>
