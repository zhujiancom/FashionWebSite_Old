	                ...
	                <s:iterator value="designers" var="designervo">
	                	<li>
		                    <table class="tablestyle">
		                        <tr>
		                            <td rowspan="3" class="portraite imgLiquidFill imgLiquid" ><a href="../designer/main/<s:property value='#designervo.id'/>.html"><img src="<%=basePath %><s:property value='#designervo.designer.imgURL'/>" /></a></td>
